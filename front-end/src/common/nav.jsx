...
const NavBar = () => {
  ...
  return (
    <nav
      id="NavBar"
      className="flex flex-col border-b mb-4 px-5 sticky top-0 h-auto border-gray-gray bg-white z-50"
    >
      <div className="flex items-center gap-4 flex-col">
        ...
        <Link
          id="home"
          className="inline-block border border-blue-400 rounded-lg py-1 px-3 bg-blue-400 text-white hover:bg-blue-700 active:ring-2 mb-2"
          to="dashboard/"
        >
          داشبورد
        </Link>
        <Link
          id="home"
          className="inline-block border border-gray-50 rounded hover:border-gray-200 text-blue-500 hover:bg-gray-200 py-1 px-3 active:ring-2 mb-2"
          to="/"
        >
          فایل ها
        </Link>
