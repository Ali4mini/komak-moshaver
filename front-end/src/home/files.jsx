...
const Files = () => {
  ...
  useEffect(() => {
    ...
    if (!isFetching) { // Prevent re-fetch if already fetching (e.g. from infinite scroll)
  ...
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [isFetching, hasMore, pageNumber, lastFilterFromStore, defaultFileType, initialLoad]); // getFiles is stable
      ...
      <header className="bg-white shadow-md sticky top-0 z-40">
        <div className="container mx-auto px-4 py-3 flex justify-between items-center">
          ...
          <button
            ...
            title={isFilterActive ? "فیلتر فعال است - کلیک برای ویرایش" : "باز کردن فیلتر"}
          >
            ...
            {isFilterActive && (
              ...
              >
                 <span className="sr-only">فیلتر فعال است</span> {/* For screen readers if they pick this up separately */}
              </span>
            )}
          </button>
        </div>
