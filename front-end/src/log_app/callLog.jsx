              ...
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-xl bg-white dark:bg-slate-800 p-6 text-left align-middle shadow-2xl transition-all">
                ...
                <div className="mt-6">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    <div>
                      <label htmlFor="customer-call-select" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    ...
                    <div>
                      <label htmlFor="call-subject-select" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
