...
def test_rent_file_tour_log(api_client, sample_rent_file, sample_rent_customer):
    url = "http://localhost:8000/api/logs/rent-tour/"
    payload = {
        "username": "test",
...
@pytest.mark.django_db
def test_sell_file_tour_log(api_client, sample_sell_file, sample_buy_customer):
    url = "http://localhost:8000/api/logs/sell-tour/"
    payload = {
        "username": "test",
