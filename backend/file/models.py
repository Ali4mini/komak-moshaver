...
#TODO: find a way to use a base class and a way to diffrenciate sell and Rent class (the current implementation is too long and messy)
...
class Sell(models.Model):
    ...
    def __str__(self) -> str:
        return f"code: {self.id} owner: {self.owner.name}"
